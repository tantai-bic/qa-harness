...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @${CLAUDE_PLUGIN_ROOT}/_bmad/bmm/workflows/testarch/test-design/workflow.yaml
